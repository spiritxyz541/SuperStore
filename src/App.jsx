    ...
    categories.forEach(cat => {
       ...
       catDuties.forEach((duty) => {
          ...
          if (activeSlots.length > 0) {
             ...
             const morningBreaksLong = ['12.00-13.30', '13.30-15.00', '15.00-16.30', '11.00-12.30'];
             const afternoonBreaksLong = ['14.30-16.00', '16.00-17.30', '13.00-14.30', '17.30-19.00'];
             const morningBreaksShort = ['12.00-13.00', '13.00-14.00', '14.00-15.00', '11.00-12.00'];
             const afternoonBreaksShort = ['14.00-15.00', '15.00-16.00', '16.00-17.00', '13.00-14.00'];
             let mIdx = 0, aIdx = 0;
